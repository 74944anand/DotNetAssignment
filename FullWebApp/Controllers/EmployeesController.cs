...
namespace FullWebApp.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var acts2023Context = _context.Employees.Include(e => e.DeptNoNavigation);
            return View(await acts2023Context.ToListAsync());
        }
        ...
        {
            ViewData["DeptNo"] = new SelectList(_context.Departments, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EmpNo,Name,Basic,DeptNo")] Employee employee)
        {
            ...
            ViewData["DeptNo"] = new SelectList(_context.Departments, "Id", "Id", employee.DeptNo);
            return View(employee);
        }
